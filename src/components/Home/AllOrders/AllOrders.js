...
const AllOrders = () => {
    ...
    // Load Orders Data
    useEffect(() => {
        fetch(`https://fathomless-gorge-61136.herokuapp.com/orders?email=${loggedInUser.email}`)
            .then(res => res.json())
    ...
    // Check Admin
    useEffect(() => {
        fetch('https://fathomless-gorge-61136.herokuapp.com/isAdmin', {
            method: 'POST',
    ...
    const ordersStatus = (id) => {
        ...
        fetch(`https://fathomless-gorge-61136.herokuapp.com/updateStatus/${id}`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
